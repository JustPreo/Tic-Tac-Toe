...
public class Positions {
    ...
    public int Ganador() {
        ...
        if (botonesPosiciones[0][0] != 0 && botonesPosiciones [0][0] == botonesPosiciones [1][1] && botonesPosiciones [0][0] == botonesPosiciones [2][2] ){
            System.out.println("DIAGONAL");
            return 1;
        
        }
        if (botonesPosiciones[0][2] != 0 && botonesPosiciones [0][2] == botonesPosiciones [1][1] && botonesPosiciones [0][2] == botonesPosiciones [2][0] ){
            System.out.println("DIAGONAL");
            return 1;
